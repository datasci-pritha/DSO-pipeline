...
from config_connection_varirables import logger, model_files

# Input Data
input_file = 'sales_model/data/7_post_transformation/train_sample.csv'

if '4_remove_multicollinearity' in model_files:
    # Uncomment if Remove MultiCollinearity is run before variable selection
    variable_file = 'sales_model/data/5_variable_shortlisting/variable_file.csv'
else:
    # Uncomment if Remove MultiCollinearity is not run before variable selection
    variable_file = 'sales_model/data/5_variable_shortlisting/variable_input_file.csv'

# Output Data
conf_matrix = 'sales_model/data/6_random_forest/confusion_matrix.csv'
sco_hist = 'sales_model/data/6_random_forest/score_history_'
pdp_val = 'sales_model/data/6_random_forest/pdp/'
pdp_spline ='sales_model/data/6_random_forest/pdp_'

# Output Plots
rel_err_graph = 'sales_model/plots/2_random_forest/relative_error_graph_'
pdpplot = 'sales_model/plots/2_random_forest/pdp_plot/'
var_imp = 'sales_model/plots/2_random_forest/variable_importance_'
roc_plot = 'sales_model/plots/2_random_forest/roc_plot_'
...
def variable_importance(inst):
    ...
    # Make the Grid Plot
    # grid = gridplot(plots_row, ncols=2, plot_width=400, plot_height=400)
...
def relative_error_graph(rf, var_seg):
    ...
    plots_row = [p1, p2]
    grid = gridplot(plots_row, ncols=2, plot_width=800, plot_height=800)
...
def variable_selection(df_):
    ...
    var_importance_out = 'sales_model/data/6_random_forest/var_importance.csv'
